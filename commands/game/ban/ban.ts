...
const command: CommandFile = {
    ...
    .addStringOption(o => o.setName("universe").setDescription("O universo para executar esta ação em").setRequired(true).addChoices(...UniverseHandler.parseUniverses() as any))
